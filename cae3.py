...
W_conv2 = weight_variable([5, 5, 100, 150])
b_conv2 = bias_variable([150])
b_conv2_de = bias_variable([100])
...
W_conv3 = weight_variable([3, 3, 150, 200])
b_conv3 = bias_variable([200])
b_conv3_de = bias_variable([150])
...
W_fc1 = weight_variable([7*7*200, 10])
b_fc1 = bias_variable([10])

h_conv3_flat = tf.reshape(h_conv3, [-1, 7*7*200])
y = tf.nn.sigmoid(tf.matmul(h_conv3_flat, W_fc1)+b_fc1)
...
loss4 = tf.nn.softmax_cross_entropy_with_logits(labels=y_, logits=y)
