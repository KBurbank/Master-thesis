...
W2_en = tf.Variable(tf.truncated_normal([500, 300], stddev = 0.1, seed = 123)) # encoder step
b2_en = tf.Variable(tf.zeros([300]))
W2_de = tf.Variable(tf.truncated_normal([300, 500], stddev = 0.1, seed = 123)) # decoder step
b2_de = tf.Variable(tf.zeros([500]))

W3 = tf.Variable(tf.truncated_normal([300, 10], stddev=0.1, seed = 123))
