...
W1_de = tf.Variable(tf.truncated_normal([300, 784], stddev = 0.1, seed = 123)) # decoder step
...
W2_de = tf.Variable(tf.truncated_normal([100, 300], stddev = 0.1, seed = 123)) # decoder step
